...
{\small
\begin{itemize}
\item A \textbf{distribution table} shows the percentage of data in each class interval. % (see Slide~\pageref{population}).
...
\item To figure out the height of a block over a class interval, divide the percentage by the length of the interval.\vspace{-.25in}
\end{itemize}
}
\begin{center}
{\setlength{\tabcolsep}{.2in}\begin{tabular}{cc}
