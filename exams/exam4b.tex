...
& Math 314\\
& Statistics\\
\hspace{5.28in} & %16 November 2011
\end{tabular}
}
...
\begin{pspicture}(0,0.1)(4,0.3)
\psline(0,0.5)(0,0)(4,0)(4,0.5)
\rput[l](0.15,0.3){30,000\ \framebox{0}\,s}
\rput[l](2.15,0.3){30,000\ \framebox{1}\,s}
\end{pspicture}
\end{center}
%Note that $\sqrt{0.25\times 0.75}\,/\sqrt{500} \approx 0.02$.
True or false? 
\smallskip
