...
```{r}
adult = read.csv("/Users/ralphwojtowicz/Desktop/math207/data/adult.csv", header=TRUE)
```
...
```{r}
youth = read.csv("/Users/ralphwojtowicz/Desktop/math207/data/youth.csv", header=TRUE)
```
