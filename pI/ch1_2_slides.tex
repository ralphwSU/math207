...
\raisebox{5pt}{Chapters 1--2: Controlled Experiments}\hfill
%\raisebox{5pt}{\insertframenumber/\pageref{lastpage}}}
\raisebox{5pt}{\insertframenumber/\inserttotalframenumber}}
...
\begin{itemize}
\item<2-> Viral infectious disease: victims are typically children
\item<2-> Can effect nervous system causing muscle weakness or paralysis 
\item<3-> Most cases cause no symptoms but can spread the disease
\item<4-> Major epidemics across the world between 1910 and 1956
\item<5-> Vaccines discovered in 1950s have made polio rare in most countries
\end{itemize}

\begin{center}
{\small\setlength{\tabcolsep}{0.2in}\begin{tabular}{ccc}
%{\includegraphics[height=1.1in]{polio_victim.eps}}
\uncover<2->{\includegraphics[height=1.1in]{polioDM.eps}}
& %\hspace{.4in}
\uncover<4->{\raisebox{-0.1in}{\includegraphics[height=1.2in,  bb=0 75 412 386, clip]{polioStatistics.eps}}}
& %\hspace{.4in}
\uncover<5->{\includegraphics[height=1.1in]{jonas-salk.eps}}\\
\uncover<2->{Polio Victim} & \uncover<4->{Infection Statistics} & \uncover<5->{Jonas Salk}
\end{tabular}}
\end{center}
...
\begin{center}
\begin{tabular}{ccc}
\uncover<5->{NFIP Study} & & \uncover<6->{Public Health Services Study}\\
\uncover<5->{\begin{pspicture}(0,0)(4,3)
\psset{linewidth=0.02,linecolor=gray}
\psframe*[linecolor=lightgray](0,2)(4,3)
   \rput(2,2.5){control}
\psframe*[linecolor=lightgray](0,0)(4,1)
   \rput(2,0.5){control}
%
\psframe*[linecolor=lightred](2.4,1)(4,2)
   \rput(3.2,1.5){no-consent}
\rput(1.3,1.5){\begin{tabular}{c}consent\\ treatment\end{tabular}}
%
\psframe(0,0)(4,3)
\psline[linecolor=black,linewidth=0.02](0,1)(4,1)
\psline[linecolor=black,linewidth=0.02](0,2)(4,2)
\psline[linecolor=black,linewidth=0.02](2.4,1)(2.4,2)
\rput(-0.2,0.5){1}\rput(-0.2,1.5){2}\rput(-0.2,2.5){3}
\rput{90}(-0.7,1.5){Grade}
\psframe[linecolor=black](0,0)(4,3)
\end{pspicture}}
& \hspace{.5in} &
\uncover<6->{\begin{pspicture}(0,0)(4,3)
\psset{linewidth=0.02,linecolor=gray}
\psframe*[linecolor=lightred](2.4,0)(4,3)
   \rput{-90}(3.2,1.5){no-consent}
%\pspolygon*[linecolor=lightgray](0,3)(2.4,3)(2.4,0)
\psframe*[linecolor=lightgray](1.2,0)(2.4,3)
\psline(0,1)(4,1)
\psline(0,2)(4,2)
\rput(-0.2,0.5){1}\rput(-0.2,1.5){2}\rput(-0.2,2.5){3}
\rput{90}(-0.7,1.5){Grade}
%\psline[linestyle=dashed,linecolor=black,linewidth=0.02](1.2,3)(1.2,0)
\psline[linecolor=black,linewidth=0.02](1.2,3)(1.2,0)
%\rput{-51.3}(1,1){treatment}
\rput{-90}(0.6,1.5){treatment}
%\rput{-51.3}(1.6,2){control}
\rput{-90}(1.8,1.5){control}
\psline[linecolor=black,linewidth=0.02](2.4,0)(2.4,3)
\rput(1.2,0.5){consent}
\psframe[linecolor=black](0,0)(4,3)
\end{pspicture}}
\end{tabular}
\end{center}
...
{\footnotesize
\begin{tabular}{cc}
\uncover<2->{NFIP Study} & \uncover<3->{Public Health Services Study}\\
\uncover<2->{\begin{tabular}{lcc}
\hline
   ...
   \end{tabular}}
&
\uncover<3->{\begin{tabular}{lcc}\hline
                 & Size      & Rate${}^*$\vphantom{\LARGE Y}\\
...
\end{center}
\uncover<2->{\scriptsize ${}^*$Rate is number of cases per 100,000 subjects.
  %$\mbox{\color{darkgreen}Green}=\mbox{consent}$  
  % $\mbox{\color{lightgray}Gray}=\mbox{consent}+\mbox{no consent}$
}

{\footnotesize\begin{center}
\begin{tabular}{ccc}
\uncover<2->{NFIP Study} & & \uncover<3->{Public Health Services Study}\\
\uncover<2->{\begin{pspicture}(0,0)(4,2.1)
\psset{linewidth=0.02,linecolor=gray,yunit=0.7}
\psframe*[linecolor=lightgray](0,2)(4,3)
   \rput(2,2.5){control}
\psframe*[linecolor=lightgray](0,0)(4,1)
   \rput(2,0.5){control}
...
\end{pspicture}}
& \hspace{.5in} &
\uncover<3->{\begin{pspicture}(0,0)(4,2.1)
\psset{linewidth=0.02,linecolor=gray,yunit=0.7}
\psframe*[linecolor=lightred](2.4,0)(4,3)
   \rput{-90}(3.2,1.5){no-consent}
%\pspolygon*[linecolor=lightgray](0,3)(2.4,3)(2.4,0)
...
\item<4-> Blue values demonstrate vaccine effectiveness: Could the 
  ${\color{blue}\textbf{71}}\to {\color{blue}\textbf{28}}$ be due to chance?
%difference be due to the 50/50    selection chance?
\item<5-> Red values demonstrate that difference between  NFIP  treatment and control groups.
% differed   in their vulnerability %(only consenting families in treatment group)
\item<6-> ${\color{blue}\textbf{71}}\to {\color{blue}\textbf{28}}$ 
    vs ${\color{red}\textbf{54}}\to 25$ shows bias in NFIP study due to confounding.
\item<7-> Average of blue values (50) differs from 46: PHS consent group was more vulnerable.
